<template>
  <div class="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden bg-slate-50 group">
    ...
    >
        ...
        <div class="min-w-full h-full relative flex flex-col justify-center items-center bg-gradient-to-b from-blue-50 to-white overflow-hidden">
             <!-- Background Blobs -->
             <div class="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
             <div class="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
             
             <!-- Content -->
             <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 scale-90 md:scale-100">
                <span class="inline-block py-1 px-3 rounded-full bg-blue-100 text-blue-800 text-sm font-semibold mb-6">
                    教育部前瞻AI技術人才培育計畫
                </span>
                <h1 class="text-4xl tracking-tight font-extrabold text-[#004d80] sm:text-5xl md:text-6xl mb-6">
                    <span class="block">智慧代理與實體AI</span>
                    <span class="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">機器人課程推動計畫</span>
                </h1>
                <p class="mt-3 max-w-md mx-auto text-base text-slate-600 sm:text-lg md:text-xl md:max-w-3xl mb-10">
                   Empowering the next generation of AI talent with Agentic AI & Physical AI curriculum.
                </p>
    ...
    <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex space-x-2">
      ...
      <button 
        ...
        :class="currentSlide === (i - 1) ? 'w-12 bg-[#004d80]' : 'w-6 bg-[#004d80]/20 hover:bg-[#004d80]/50'"
      ></button>
    </div>
  </div>
</template>
