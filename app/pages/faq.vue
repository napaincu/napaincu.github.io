    ...
    <section class="py-20 bg-white min-h-screen">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl font-bold text-[#004d80] inline-block relative after:content-[''] after:block after:w-2/3 after:h-1 after:bg-blue-500 after:mx-auto after:mt-2">常見問題</h1>
                <p class="mt-6 text-lg text-slate-600">關於讀書會與課程推動計畫的常見問題</p>
            </div>
                        ...
                        <div v-show="activeIndex === index" class="overflow-hidden">
                            <div class="px-6 pb-6 pt-2">
                                <div class="flex items-start gap-4 bg-white rounded-lg p-5 shadow-sm border border-blue-100">
                                    <!-- A Icon -->
                                    <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-lg">
                                        A
                                    </div>
                                    <!-- Answer Text -->
                                    <div class="flex-1 pt-1">
                                        <p class="text-slate-700 leading-relaxed whitespace-pre-line">{{ item.answer }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-16 bg-gradient-to-br from-[#004d80] to-blue-700 rounded-2xl shadow-xl p-8 text-white">
                <div class="text-center">
                    ...
                    <p class="text-blue-100 mb-6 text-lg">歡迎隨時與我們聯繫，我們很樂意為您解答</p>
                    <NuxtLink 
                        to="/contact"
...
const faqItems = [
    {
        ...
        answer: '已從事機器人或 Agentic AI 研究、或曾開設機器人或 Agentic AI 相關課程的教師。'
    },
    {
        question: '誰可以參與讀書會？',
